  ...
  return (
    <Link to={`/${type}/${preview.id}`} style={{textDecoration: 'none'}}>
      <div className="preview-card">
        {type == "posts" && <div className="post-card__rating post-card__rating--green post-card__rating--sm">
            <h4>4.2</h4>
        </div>}
        ...
        <VideoViaUrl muted={true} controls={false} backupClass="" url={preview.thumbnailPath}/>
        }
